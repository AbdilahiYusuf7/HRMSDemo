    ...
    <script>
        ...
        function buildDepartmentPromotionData() {
            const departmentLevels = [
                { department: 'Human Resource', value: 8 },
                { department: 'Finance', value: 6 },
                { department: 'Operations', value: 5 },
                { department: 'Marketing', value: 4 },
                { department: 'Administration', value: 7 },
                { department: 'Information Technology', value: 3 }
            ];

            return {
                labels: departmentLevels.map(item => item.department),
                values: departmentLevels.map(item => item.value)
            };
        }
