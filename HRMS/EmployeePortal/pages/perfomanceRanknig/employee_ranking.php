...
<body class="flex min-h-screen bg-slate-50">
    ...
    <script>
        ...
        const employeeRankingRecords = [
            { name: 'Cabdiraxmaan Cali', employeeId: 'EMP-0001', organization: 'HRMS Pro', branch: 'Idaacada Branch', department: 'Human Resource', team: 'People Operations', currentRole: 'Human Resource Officer', rank: 'Officer II', grade: 'G6', dateJoined: '2021-01-12', yearsInRole: 4, performance: '92%', performanceLevel: 'high', qualification: 'Bachelor Degree', eligibility: 'Eligible', status: 'Active' },
        ...
        function buildEmployeeViewUrl(record) {
            const params = new URLSearchParams({
                ...
                avatar: `https://api.dicebear.com/7.x/avataaars/svg?seed=${encodeURIComponent(record.name)}`,
