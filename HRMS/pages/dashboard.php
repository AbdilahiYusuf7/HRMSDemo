...
<body class="flex min-h-screen bg-slate-50">
    ...
    <div class="mx-auto w-full max-w-[1440px] p-4 md:p-8">
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="py-4">
                                <p class="text-sm text-slate-600 font-medium">Bakaaraha Branch</p>
                            </td>
                            <td class="py-4">
        ...
        <!-- Location Overview -->
        <div class="glass-card p-6 flex flex-col">
            <h3 class="font-bold text-slate-800 mb-6">Regional Branches</h3>
            <div class="space-y-6 flex-grow">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-slate-400">Muqdisho</p>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-slate-400">Burco</p>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-bold text-slate-700">Boosaaso</p>
                            <p class="text-[10px] text-slate-400">Puntland</p>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-bold text-slate-700">Kismaayo</p>
                            <p class="text-[10px] text-slate-400">Jubaland</p>
                        </div>
                    </div>
                    <p class="text-sm font-bold text-rose-600">190</p>
                </div>
            </div>
            <button class="mt-8 w-full py-3 bg-slate-50 text-slate-600 text-xs font-bold rounded-xl hover:bg-slate-100 transition-colors border border-slate-200">
                View Location Map
            </button>
        </div>
        </div>
    ...
    <script>
        ...
        const attendanceInsightRecords = [
            { employee: 'Fadumo Xasan', department: 'Finance', originalCheckIn: '08:00 AM', actualCheckIn: '08:17 AM', minutesLate: 17, late: true, outOfWindow: true, absent: false },
            ...
            { employee: 'Mustafe Cabdi', department: 'Information Technology', originalCheckIn: '08:00 AM', actualCheckIn: '08:26 AM', minutesLate: 26, late: true, outOfWindow: true, absent: false },
            ...
            { employee: 'Nimco Ahmed', department: 'Marketing', originalCheckIn: '08:00 AM', actualCheckIn: '08:09 AM', minutesLate: 9, late: true, outOfWindow: true, absent: false }
        ];
        ...
        const dashboardCardConfig = [
            ...
            { key: 'outOfWindow', label: 'Out of Window', border: 'border-indigo-500', iconBg: 'bg-indigo-50', iconColor: 'text-indigo-600', icon: 'fa-triangle-exclamation', helper: 'Check-ins outside the allowed window', modalTitle: 'Out of Window Check Ins', modalSubtitle: 'Employees whose check-in was outside the allowed attendance window.' },
