...
<body class="flex min-h-screen bg-slate-50">
    ...
    <script>
        ...
        function renderApproachingRetirementCards() {
            ...
            approachingRetirementCards.innerHTML = nextThreeMonths.map((record, index) => {
                const accentSets = [
                    { avatarBg: 'bg-indigo-50', avatarText: 'text-indigo-600' },
                    { avatarBg: 'bg-rose-50', avatarText: 'text-rose-600' },
                    { avatarBg: 'bg-amber-50', avatarText: 'text-amber-600' }
                ];
                    ...
                    <div class="glass-card retirement-card rounded-[1.4rem] p-6">
                        <div class="flex items-start justify-between gap-4">
                            <div class="flex items-start gap-4">
                                <div class="flex h-16 w-16 items-center justify-center rounded-2xl ${accent.avatarBg} ${accent.avatarText} text-[1.9rem] font-bold">${getInitials(record.name)}</div>
                                <div>
