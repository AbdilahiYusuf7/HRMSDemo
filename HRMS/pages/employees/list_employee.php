        ...
        <div class="mb-8 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-5">
            ...
            <div class="glass-card insight-card border-l-4 border-rose-500 p-5">
                <div class="flex items-start justify-between">
                    <div>
                        <p class="text-sm font-medium text-slate-500">On Leave Employees</p>
                        <h3 class="mt-2 text-2xl font-bold text-slate-800">12</h3>
                    </div>
                    <div class="rounded-xl bg-rose-50 p-3 text-rose-600">
                        <i class="fa-solid fa-calendar-xmark text-lg"></i>
                    </div>
                </div>
                <p class="mt-4 text-[11px] font-medium text-slate-400">Long-term leave cases under review</p>
            </div>
        </div>
                ...
                <table class="min-w-full text-left">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        <tr class="transition-colors hover:bg-slate-50/70">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Cabdirahman" alt="Employee" class="h-10 w-10 rounded-full border border-slate-200 bg-slate-100">
                                    <div>
                        ...
                        <tr class="transition-colors hover:bg-slate-50/70">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Fadumo" alt="Employee" class="h-10 w-10 rounded-full border border-slate-200 bg-slate-100">
                                    <div>
                        ...
                        <tr class="transition-colors hover:bg-slate-50/70">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Mahad" alt="Employee" class="h-10 w-10 rounded-full border border-slate-200 bg-slate-100">
                                    <div>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    <a href="view_employee.php" class="view-employee-link flex h-9 w-9 items-center justify-center rounded-lg bg-slate-50 text-slate-500 transition hover:bg-indigo-50 hover:text-indigo-600" data-name="Mahad Axmed" data-employee-number="EMP-0003" data-department="Operations" data-branch="Togdheer Branch" data-join-date="2022-08-16" data-status="Active" data-status-class="status-active" data-avatar="https://api.dicebear.com/7.x/avataaars/svg?seed=Mahad" data-designation="Operations Supervisor" data-phone="+252 65 555 0303" data-email="mahad.axmed@hrms.local" data-location="Togdheer, Hargeisa" data-gender="Male" data-dob="1990-12-01" data-employment-type="Full Time" data-reporting-manager="Hodan Ali"><i class="fa-regular fa-eye text-sm"></i></a>
                                    <button class="flex h-9 w-9 items-center justify-center rounded-lg bg-slate-50 text-slate-500 transition hover:bg-amber-50 hover:text-amber-600"><i class="fa-regular fa-pen-to-square text-sm"></i></button>
                                    <button class="flex h-9 w-9 items-center justify-center rounded-lg bg-slate-50 text-slate-500 transition hover:bg-rose-50 hover:text-rose-600"><i class="fa-solid fa-user-slash text-sm"></i></button>
                                </div>
                            </td>
                        ...
                        <tr class="transition-colors hover:bg-slate-50/70">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Sahra" alt="Employee" class="h-10 w-10 rounded-full border border-slate-200 bg-slate-100">
                                    <div>
