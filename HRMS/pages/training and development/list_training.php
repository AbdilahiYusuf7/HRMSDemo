...
<body class="flex min-h-screen bg-slate-50">
    ...
    <div class="mx-auto w-full max-w-[1440px] p-4 md:p-8">
        <div class="mb-8 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <button id="openTrainingModal" type="button" class="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-3 text-sm font-semibold text-white transition hover:bg-indigo-500">
        ...
        <div class="glass-card p-6">
            ...
            <div class="overflow-hidden">
                <table class="training-table text-left">
                    <thead>
    ...
    <div id="registeredTraineesModal" class="fixed inset-0 z-50 hidden items-center justify-center p-4 sm:p-6">
        ...
        <div class="glass-card dialog-panel relative z-10 mx-auto flex max-h-[calc(100vh-3rem)] w-full max-w-4xl flex-col overflow-hidden">
            <div class="flex items-start justify-between gap-4 border-b border-slate-100 px-6 py-5 sm:px-7">
                ...
                <button id="closeRegisteredTraineesModal" type="button" class="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition hover:bg-slate-200 hover:text-slate-700">
    ...
    <div id="trainingModal" class="fixed inset-0 z-50 hidden items-center justify-center p-4 sm:p-6">
        ...
        <div class="glass-card dialog-panel relative z-10 mx-auto flex max-h-[calc(100vh-3rem)] w-full max-w-xl flex-col overflow-hidden">
            <div class="flex items-start justify-between gap-4 border-b border-slate-100 px-6 py-5 sm:px-7">
                ...
                <button id="closeTrainingModal" type="button" class="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition hover:bg-slate-200 hover:text-slate-700">
                    <i class="fa-solid fa-xmark text-base"></i>
                </button>
            </div>
            <div class="max-h-[calc(100vh-13rem)] overflow-y-auto">
                <form id="trainingForm" class="grid gap-5 p-6 md:grid-cols-2 sm:px-7 sm:pb-7">
                    ...
                    <div class="md:col-span-2 flex justify-end gap-3 border-t border-slate-100 pt-5">
                        <button id="cancelTrainingModal" type="button" class="rounded-xl border border-slate-200 px-4 py-3 text-sm font-semibold text-slate-600 transition hover:bg-slate-50">Cancel</button>
                        <button type="submit" class="rounded-xl bg-indigo-600 px-4 py-3 text-sm font-semibold text-white transition hover:bg-indigo-500">Save Training</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            trainingTableBody.innerHTML = trainingRecords
                ...
                .map(record => `
                    <tr class="transition-colors hover:bg-slate-50/70">
                        ...
                        <td class="px-4 py-4">
                            <button type="button" class="view-registered-trainees inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-600 transition hover:bg-slate-50" data-training-id="${record.id}">
